...
/home/weiqj/workspace/public/libertas-samples/rust/libertas-weather/translations/libertas-weather.en.doc.json

Write the translated document directly into this output folder:
/home/weiqj/workspace/public/libertas-samples/rust/libertas-weather/translations

The output filename must be exactly `libertas-weather.zh-Hans.doc.json`. The source locale is `en`.
